...
Zip files protected with a password can be read by setting the **Zip Password** field in the connector configuration, whether the archive uses a traditional ("ZipCrypto") password or WinZip's "AES-256" encryption option.
...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.20.1 | 2026-09-24 | [PR_NUMBER_TODO](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_TODO) | Fix `pad_missing_columns` crashing (`int()`/`float()` on `None`) on rows padded in non-string schema columns, which could yield 0 records for streams where padding is common |
| 4.20.0 | 2026-09-24 | [PR_NUMBER_TODO](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_TODO) | Add `pad_missing_columns` CSV format option to pad short rows with nulls instead of dropping/failing them |
| 4.19.0 | 2026-07-22 | [PR_NUMBER_TODO](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_TODO) | Fix a severe read-speed regression when reading files out of zip archives: line splitting no longer decodes one byte at a time |
| 4.18.0 | 2026-07-22 | [PR_NUMBER_TODO](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_TODO) | Remove the fixed 1.5GB file size limit in file-transfer ("Copy raw files") mode; files are now only rejected if the sync pod doesn't have enough free disk space to hold them |
| 4.17.0 | 2026-07-22 | [PR_NUMBER_TODO](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_TODO) | Add support for AES-256 (WinZip AES) password-protected zip files |
| 4.16.0 | 2026-07-22 | [PR_NUMBER_TODO](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_TODO) | Add support for password-protected (ZipCrypto) zip files |
| 4.15.14 | 2026-07-21 | [82568](https://github.com/airbytehq/airbyte/pull/82568) | Update dependencies |
| 4.15.13 | 2026-07-14 | [81995](https://github.com/airbytehq/airbyte/pull/81995) | Update dependencies |
| 4.15.12 | 2026-07-07 | [81447](https://github.com/airbytehq/airbyte/pull/81447) | Update dependencies |
| 4.15.11 | 2026-06-30 | [81236](https://github.com/airbytehq/airbyte/pull/81236) | Update dependencies |
| 4.15.10 | 2026-06-23 | [80620](https://github.com/airbytehq/airbyte/pull/80620) | Update dependencies |
| 4.15.9 | 2026-06-16 | [80010](https://github.com/airbytehq/airbyte/pull/80010) | Update dependencies |
| 4.15.8 | 2026-06-10 | [79599](https://github.com/airbytehq/airbyte/pull/79599) | Fix CSV sync failures for files with trailing empty headers by upgrading CDK to v7.21.2 |
| 4.15.7 | 2026-06-09 | [79485](https://github.com/airbytehq/airbyte/pull/79485) | Update dependencies |
| 4.15.6 | 2026-06-02 | [78421](https://github.com/airbytehq/airbyte/pull/78421) | Throttle per-slice state-message emission to once every 10 minutes to prevent the orchestrator's state buffer OOMing on streams with many files. Final state is force-emitted at end of stream so the destination always sees the latest cursor. |
| 4.15.5 | 2026-06-02 | [78945](https://github.com/airbytehq/airbyte/pull/78945) | Update dependencies |
...
| 4.14.3 | 2025-09-15 | [66023](https://github.com/airbytehq/airbyte/pull/66023) | Update to CDK v7 |
